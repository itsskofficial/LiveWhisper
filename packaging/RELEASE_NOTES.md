...
- **Private by default.** Speech, formatting and writing all run on your PC. Add a free Groq key if you want the cloud: about 2 s from the end of speech to pasted text.
...
- On a laptop running on battery, Windows caps the GPU and local dictation is several times slower. Plug in, or add a Groq key.
